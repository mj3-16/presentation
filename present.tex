...
\newcommand{\highlight}[1]{\color{orange}\textbf{#1}}
...
class Test {
	...
	public boolean run(){
		...
		|\mymonly{-5}{int imm =}\mymonly{1}{ size * 3 + 4}\myhonly{2}{ size}\myhonly{3}{ 10}\myonly{2-3}{ * 3 + 4}\myhonly{4}{ 30 + 4}\myhonly{5}{ 34}\mymonly{-5}{;}\myhonly{6}{int imm = 34;}|
		int[] result = createArray(|\myonly{1}{size}\myhonly{2}{size}\myhonly{3}{10}\mymonly{4-}{10}|, |\mymonly{-5}{imm}\myhonly{6}{imm}\myhonly{7}{34}|);
		return result[0] == |\mymonly{-5}{imm}\myhonly{6}{imm}\myhonly{7}{34}|;
	}
